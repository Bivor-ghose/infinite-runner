...
createCanvas(displayWidth-65,displayHeight-170);
  
// Moving background
path=createSprite(275,displayHeight/2,1000,100);
path.addImage(pathImg);

path.scale=2
//creating boy running
mainCyclist  = createSprite(70,displayHeight/2,20,20);
...
function obstacle(){
  if (frameCount%60==0){
    ...
    obst.scale=0.1;
    obst.velocityX=-(5+2*distance/30);
     obstG.add(obst);
  }
}
function obstacle2(){
  if (frameCount%70==0){
    ...
    obst2.scale=0.1;
    obst2.velocityX=-(5+2*distance/30);
    obst2G.add(obst2);
  }
}
function obstacle3(){
  if (frameCount%80==0){
    ...
    obst3.scale=0.1;
    obst3.velocityX=-(5+2*distance/30);
    obstG.add(obst3);
  }
}
function opponent(){
...
function opponent2(){
  if (frameCount%60==0){
    ...
    opp2.lifetime=250;
    opp2.scale=0.1;
    opp2.velocityX=-(3+2*distance/30);
...
function opponent3(){
  if (frameCount%60==0){
    ...
    opp3.lifetime=250;
    opp3.scale=0.1;
    opp3.velocityX=-(3+2*distance/30);
  opp3G.add(opp3);
  }
}
